import { Container, RenderGroup, RenderLayer, Text, Sprite, Texture, ColorMatrixFilter } from 'pixi.js';
...
export default class GameUI {
    ...
    initializeUI() {
        ...
        spinButton.on('pointerupoutside', () => this.onButtonClick(spinButton, false));
    ...
    updateScale(scale = 1) {
        if (this.elements.winText) {
            ...
            this.elements.winText.style.wordWrapWidth = (this.config.baseWidth - 60) * scale;
        }
    }
}